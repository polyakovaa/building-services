...
const (
	AttachmentService_AddAttachment_FullMethodName    = "/project.v1.AttachmentService/AddAttachment"
	AttachmentService_ListAttachments_FullMethodName  = "/project.v1.AttachmentService/ListAttachments"
	AttachmentService_DeleteAttachment_FullMethodName = "/project.v1.AttachmentService/DeleteAttachment"
	AttachmentService_GetAttachment_FullMethodName    = "/project.v1.AttachmentService/GetAttachment"
)
...
func (c *attachmentServiceClient) AddAttachment(ctx context.Context, in *AddAttachmentRequest, opts ...grpc.CallOption) (*Attachment, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Attachment)
	err := c.cc.Invoke(ctx, AttachmentService_AddAttachment_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAttachmentServiceServer) AddAttachment(context.Context, *AddAttachmentRequest) (*Attachment, error) {
...
func _AttachmentService_AddAttachment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AttachmentService_AddAttachment_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AttachmentServiceServer).AddAttachment(ctx, req.(*AddAttachmentRequest))
	}
...
var AttachmentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "project.v1.AttachmentService",
	...
	Metadata: "project/v1/attachment.proto",
}
