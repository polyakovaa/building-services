...
const (
	TaskService_CreateTask_FullMethodName       = "/project.v1.TaskService/CreateTask"
	TaskService_GetTask_FullMethodName          = "/project.v1.TaskService/GetTask"
	TaskService_ListTasks_FullMethodName        = "/project.v1.TaskService/ListTasks"
...
func (c *taskServiceClient) ListMyTasks(ctx context.Context, in *ListMyTasksRequest, opts ...grpc.CallOption) (*ListTasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTasksResponse)
...
func (UnimplementedTaskServiceServer) ListMyTasks(context.Context, *ListMyTasksRequest) (*ListTasksResponse, error) {
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "project.v1.TaskService",
	...
	Metadata: "project/v1/task.proto",
}
