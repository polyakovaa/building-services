...
type NotificationServiceClient interface {
	...
	MarkAllAsRead(ctx context.Context, in *MarkAllAsReadRequest, opts ...grpc.CallOption) (*UnreadCountResponse, error)
}
...
func (c *notificationServiceClient) MarkAllAsRead(ctx context.Context, in *MarkAllAsReadRequest, opts ...grpc.CallOption) (*UnreadCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UnreadCountResponse)
...
type NotificationServiceServer interface {
	...
	MarkAllAsRead(context.Context, *MarkAllAsReadRequest) (*UnreadCountResponse, error)
...
func (UnimplementedNotificationServiceServer) MarkAllAsRead(context.Context, *MarkAllAsReadRequest) (*UnreadCountResponse, error) {
